...
stargazer(m1, m2, title="Linear Regression Results", dep.var.labels="Obama Feeling Thermometer", covariate.labels=c("Household Income (Thousands)", "Age ","Education","Gender","Race","Democrat","Republican","Democrat:Income"), align=FALSE, omit.stat=c("adj.rsq", "f", "ser"), label="T:res", no.space=TRUE)
@
