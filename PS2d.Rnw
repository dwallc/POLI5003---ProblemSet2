...
stargazer(m1, m2, m3, title="Linear Regression Results (Q1 and Q2)", dep.var.labels="Obama Feeling Thermometer", covariate.labels=c("Household Income (In Thousands)", "Age ","Education","Gender","Race","Democrat", "Non-Democrat", "Republican","Democrat:Income", "Non-Democrat"), align=TRUE, omit.stat=c("adj.rsq", "f", "ser"), label="T:res", no.space=TRUE)
@
